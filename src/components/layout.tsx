...
export default function Layout({ children }: LayoutProps) {
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="w-full max-w-4xl h-full bg-amber-50 shadow-2xl rounded-2xl flex flex-col overflow-hidden relative">
        ...
        <div className="absolute left-8 top-0 bottom-0 w-6 flex flex-col justify-around items-center py-12 pointer-events-none z-20">
          <div className="w-4 h-4 rounded-full bg-white border-2 border-gray-300 shadow-inner" />
          <div className="w-4 h-4 rounded-full bg-white border-2 border-gray-300 shadow-inner" />
          <div className="w-4 h-4 rounded-full bg-white border-2 border-gray-300 shadow-inner" />
        </div>
        
        <div className="absolute left-20 top-0 bottom-0 w-0.5 bg-red-300 opacity-50 pointer-events-none z-10" />
